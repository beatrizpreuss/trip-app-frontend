            ...
            <div className="flex flex-row gap-5 mb-10">
                <Link to="/trips">
                    <button type="button" className="w-50 h-10 text-zinc-100 bg-zinc-900 hover:bg-zinc-800 hover:font-bold focus:ring-4 
                            ...
                            dark:bg-zinc-100 dark:hover:bg-zinc-200 dark:focus:ring-zinc-800 dark:text-zinc-800">Start planning
                    </button>
                </Link>
                <Link to="/find-destinations">
                    <button type="button" className="w-50 h-10 text-zinc-100 bg-zinc-900 hover:bg-zinc-800 hover:font-bold focus:ring-4 
                            focus:outline-none focus:ring-zinc-300 font-medium rounded-lg text-sm px-4 py-2 text-center 
                            dark:bg-zinc-100 dark:hover:bg-zinc-200 dark:focus:ring-zinc-800 dark:text-zinc-800">Get ideas
                    </button>
                </Link>
            </div>
            <img src={mainImage} alt="Planning a trip"/>
            <h2 className="text-3xl font-bold mt-20 mb-10">Let's plan—together</h2>
