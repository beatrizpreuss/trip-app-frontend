...
export default function ThemeToggle() {
    ...
    return (
        <button onClick={toggleTheme}>
            {isDark ? (
                <svg className="ml-3 w-6 h-6 text-gray-800 dark:text-[#dddddd]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
