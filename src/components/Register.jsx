...
export default function Register() {
    ...
    return (
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div className="w-full bg-[var(--color-light-blue)] rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 dark:text-[var[--color-stale-blue]] dark:bg-[var(--color-darker-blue)]">
