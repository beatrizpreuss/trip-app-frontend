        ...
        <footer className="bg-zinc-100 rounded-lg shadow-sm dark:bg-zinc-900 m-4">
            <div className="w-full mx-auto px-11 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap space-x-6 items-center mb-6 text-sm font-medium text-zinc-900 sm:mb-0 dark:text-zinc-100">
                        <li>
                ...
                <span className="block text-sm text-zinc-900 sm:text-center dark:text-zinc-100">© 2025 <a href="/" className="hover:underline">WanderWise™</a>. All Rights Reserved.</span>
            </div>
        </footer>
    )
}